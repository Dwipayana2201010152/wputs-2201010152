    ...
    if(isset($_POST["act"])){
        ...
        switch ($act){
            case "store":
                    ...
                    $nim = $_POST["txNIM"];
                    $prodi = $_POST["txPRODI"];
                    $jenis_kelamin = $_POST["txJKL"];
                    $tgl_lahir = $_POST["txTGL"];
                    $idmhs = md5($nim);
                    $sql = "INSERT INTO tbmhs(nama, nim, prodi, jenis_kelamin, tgl_lahir, idmhs) VALUES('$nama', '$nim', '$prodi', '$jenis_kelamin', '$tgl_lahir', '$idmhs');";
            ...
            case "update":
                    ...
                    $nim = $_POST["txNIM"];
                    $prodi = $_POST["txPRODI"];
                    $jenis_kelamin= $_POST["txTGL"];
                    $tgl_lahir = $_POST["txJKL"];
                    $idmhs = $_POST["idmhs"];
                    $sql = "UPDATE tbmhs SET nama='$nama', nim='$nim', prodi='$prodi', Jenis_kelamin='$jenis_kelamin', tgl_lahir='$tgl_lahir' WHERE idmhs='$idmhs';";
                    $hasil = mysqli_query($cnn, $sql);
                    if($hasil){
                        $footer = "<script>
                        Swal.fire({
