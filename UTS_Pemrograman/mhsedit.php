<?php
    $idmhs = $_GET["p1"];
    $sql = "SELECT tu.nama, tu.nim, tu.prodi, tu.jenis_kelamin, tu.tgl_lahir FROM tbmhs tu WHERE tu.idmhs='$idmhs';";
...
<form method="POST" action="datamahasiswa.php">
    ...
    <div class="form-floating mb-3">
        <input type="text" name="txJKL" class="form-control" id="floatingInput" placeholder="Jenis kelamin" value="<?=$h["jenis_kelamin"]?>">
